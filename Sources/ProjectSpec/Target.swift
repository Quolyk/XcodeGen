...
public struct Target: ProjectTarget {
    ...
    public var isResoursePhaseBeforeSourse: Bool
    ...
    public init(
        ...
        isResoursePhaseBeforeSourse: Bool = false
    ) {
        self.name = name
        self.type = type
        ...
        self.isResoursePhaseBeforeSourse = isResoursePhaseBeforeSourse
    }
}
...
extension Target: NamedJSONDictionaryConvertible {
    ...
    public init(name: String, jsonDictionary: JSONDictionary) throws {
        ...
        isResoursePhaseBeforeSourse = jsonDictionary.json(atKeyPath: "isResoursePhaseBeforeSourse") ?? false
    }
}
...
extension Target: JSONEncodable {
    public func toJSONValue() -> Any {
        ...
        if isResoursePhaseBeforeSourse {
            dict["isResoursePhaseBeforeSourse"] = true
        }
